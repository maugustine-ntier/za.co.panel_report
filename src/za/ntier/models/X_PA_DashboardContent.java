...
// Y
	...
	*/
	...
	public org.compiere.model.I_AD_Process getAD_Process_Report() throws RuntimeException
	{
		return (org.compiere.model.I_AD_Process)MTable.get(getCtx(), org.compiere.model.I_AD_Process.Table_ID)
			.getPO(getAD_Process_Report_ID(), get_TrxName());
	}

	/** Set Process Report.
		@param AD_Process_Report_ID Process Report
	*/
	public void setAD_Process_Report_ID (int AD_Process_Report_ID)
	{
		if (AD_Process_Report_ID < 1)
			set_Value (COLUMNNAME_AD_Process_Report_ID, null);
		else
			set_Value (COLUMNNAME_AD_Process_Report_ID, Integer.valueOf(AD_Process_Report_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_AD_Process_Report_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
